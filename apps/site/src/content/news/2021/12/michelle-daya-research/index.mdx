...
seo:
  title: BioData Catalyst Used for Genomics Research on Link Between Genetic Risk and Allergic Disease
excerpt: >
  Do you enjoy the smell of freshly cut grass, or do you fall victim to sneezing and an 
  incessantly runny nose from pollen? Do you jump at the chance to scratch household pets 
  such as cats and dogs, or do you fear constant coughing and a scratchy throat from their 
  coats? If you're the latter in these questions, you're not alone. These symptoms aren't 
  unheard of for those that suffer from common allergies. Common allergies have markers in 
  the body that scientists are studying to learn more about how to alleviate these types of 
  symptoms. But, in order to understand the markers and how to treat them, researchers also 
  need to understand who is affected.

---

import ProfileCard from '@components/cards/ProfileCard.astro'
import Figure from '@components/news/Figure.astro'
import photo from './daya-michelle.jpg'
import infographic from './clinical-characteristics.png';
...
<ProfileCard
  name="Michelle Daya"
  credentials="PhD"
  role="Human Genetics Researcher"
  summary="Focuses on how genetic makeup influences risk for developing common allergies such as asthma and eczema."
  image={photo}
  imageAlt="Michelle Daya, PhD"
  tone="cool"
  links={[
    { label: 'View PubMed abstract', href: 'https://pubmed.ncbi.nlm.nih.gov/34536413/' },
    { label: 'View full article', href: 'https://doi.org/10.1016/j.jaci.2021.09.011' },
  ]}
/>
...
<Figure
  src={infographic}
  alt="Clinical Characteristics Figure"
  caption="Figure 1. Clinical characteristics. 1A Breakdown of ancestry, disease group and genotyping platform across studies. 1B Barplot of the total serum IgE IU/ml geometric mean by study, stratified by allergic/non-allergic group, colored by ancestry. https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8665111/figure/F1/"
  float="right"
  width="normal"
/>
...
> One thing that is very important in science is reproducible research.
  <span class="attribution">Michelle Daya, Human Genetics Researcher</span>
